...
def get_wrong_prediction(prediction, actual, dataset, wrong_ind):
...
gini_wrong=set()
wrong_data = get_wrong_prediction(prediction_gini, actual_gini, test_data,gini_wrong)
...
entropy_wrong=set()
wrong_data_en = get_wrong_prediction(prediction_entropy, actual_entropy, test_data,entropy_wrong)
print('wrong predictions for entropy :', len(wrong_data_en))
...
mis_wrong=set()
wrong_data_mis = get_wrong_prediction(prediction_miss, actual_miss, test_data,mis_wrong)
print('wrong predictions for misclassifcation_error :', len(wrong_data_mis))

print('no of samples Entropy correctly classifies but gini dont :', (len(gini_wrong-entropy_wrong)))
print('no of samples wrong classified in gini and Entropy ', len(gini_wrong),len(entropy_wrong))

print('no of samples misclaffication correctly classifies but gini dont :', (len(gini_wrong- mis_wrong)))
print('no of samples wrong classified in gini and misclassification :', (len(gini_wrong), len(mis_wrong)))
